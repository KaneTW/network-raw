...
-   Add a synopsis to `network-raw.cabal`. It should be a short (one sentence)
    explanation of your project.

-   Add a category to `network-raw.cabal`. A list of categories is available on
...
[network-raw]: https://github.com/KaneTW/network-raw
